...
dotenv_path = Path(".git/.env")  # Adjust the path if needed
...
print(image_query('Write a short label of what is show in this image?', image_path))
...
user_query = 'What is the main purpose of this item?'
prompt = f"""
